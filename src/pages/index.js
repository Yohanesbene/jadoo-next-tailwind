        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex">
            <div className="w-6/12 pt-52">
              <h1 className="text-accent-2 font-bold uppercase text-xl mb-6">Best Destinations around the world</h1>
              <h2 className="text-gray-900 font-serif text-[84px] leading-[89px] tracking-tighter mb-8">Travel,{" "}
                ...
                and live a new
                and full life</h2>
              <p className="text-gray-400 max-w-lg font-medium leading-8 mb-8">Built Wicket longer admire do barton vanity itself do in it. Preferred to sportsmen it engrossed listening. Park gate sell they west hard for the.</p>
              <div className="flex">
                <Link href="/">
          ...
          <div className="flex text-gray-900">
            ...
            <div className="w-3/12 px-8">
              <div className="relative transition-all duration-300 group shadow-none hover:shadow-great flex flex-col items-center justify-center text-center bg-white rounded-[36px]">
                ...
                <h5 className="px-8 mb-8">We deliver outsourced
          ...
          <div className="flex">
            ...
            <div className="w-5/12 flex items-center justify-center">
              <div className="w-[370px] relative">
                ...
                <div className="absolute bottom-16 right-0 tranform translate-x-1/2 bg-white rounded-2xl w-[263px] z-30 shadow-great p-4 pr-7">
                  <div className="flex">
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          ...
          <div className="w-full relative-bg-white">
            <div className="relative">
              <div className="absolute flex items-center justify-center text-white rounded-full transform -translate-y-1/2 translate-x-1/2 z-30 top-0 right-0 w-16 h-16 bg-gradient-to-b from-accent-6/60 to-accent-6">
              ...
              <div className="bg-accent-3/20 overflow-hidden rounded-tl-[129px] rounded-3xl relative z-20 pt-20 pb-20 mb-8">
                <div className="relative">
                  ...
                  <div className="relative z-10">
                    <h6 className="text-gray-500 font-bold text-3xl px-36 text-center leading-normal mb-20">Subscribe to get information, latest news and other
                    ...
                    <form className="flex justify-center">
                      <fieldset className="relative mr-8">
                        ...
                        <input type="text" placeholder='Your Email' className='appearance-none rounded-lg py-4 pl-14 bg-white w-96 focus:outline-none transition duration-300 border-20 border-transparent focus:border-accent-6' />
                      </fieldset>
                      <button className="rounded-lg text-white bg-gradient-to-b from-accent-2/90 to-accent-2 py-4 px-16">Subscribe</button>
                    </form>
                  </div>
                </div>
            ...
            <div className="w-3/12 px-4">
              ...
              <ul className="flex">
                <li className="relative w-28 h-9">
                  ...
                  >
                    <Image className="object-none" layout="fill" src="/images/google-play.png" alt="Google Play" />
                  </a>
                </li>
                <li className="relative w-28 h-9">
                  <a
                    ...
                    className="w-full h-full relative flex overflow-hidden rounded-full"
                  >
                    <Image className="object-none" layout="fill" src="/images/app-store.png" alt="App Store" />
                  </a>
                </li>
              </ul>
            </div>
